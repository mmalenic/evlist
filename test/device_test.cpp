...
TEST(InputDeviceTest, Filter) {
    ...
    auto combined_regex = evlist::InputDevices{std::vector{first, second}};
    ...
    auto capabilities = evlist::InputDevices{std::vector{first, second}};
    capabilities.filter(
    ...
    auto capabilities_regex = evlist::InputDevices{std::vector{first, second}};
    ...
    auto combined_not_found = evlist::InputDevices{std::vector{first, second}};
    ...
    auto combined_not_found_regex =
        evlist::InputDevices{std::vector{first, second}};
